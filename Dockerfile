...
# # ---MySQL---
# # Server installation
RUN sudo apt-get install mysql-client -y > /dev/null
...
RUN sudo cp /root/kc-server/communicator-rest/communicator-rest-2.4.3-SNAPSHOT.war /opt/apache-tomcat-7.0.76/webapps/khcrest.war
